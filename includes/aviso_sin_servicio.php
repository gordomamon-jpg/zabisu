...
<div class="ss-overlay" id="ss-overlay">
    <div class="ss-card">
        ...
        <p class="ss-texto">
            Del <strong><?php echo htmlspecialchars($ss_rangoTexto); ?></strong>
            no podremos tomar ni entregar pedidos.
        </p>
        <p class="ss-disculpa">Te esperamos el <?php echo htmlspecialchars($ss_fechaRegresoTexto); ?> con todo el sabor de siempre.</p>
        <span class="ss-badge">
