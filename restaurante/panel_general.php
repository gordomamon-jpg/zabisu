...
<div class="contenedor">
    ...
    <div class="panel-accesos">
        ...
        <a href="difusion.php" class="panel-acceso panel-acceso--menus">
            <div class="panel-acceso__icono">📣</div>
            <div class="panel-acceso__contenido">
                <strong class="panel-acceso__titulo">Difusión WhatsApp</strong>
                <span class="panel-acceso__desc">Envía el menú del día a todos tus clientes</span>
            </div>
        </a>
        ...
        <a href="cotizaciones.php" class="panel-acceso">
            <div class="panel-acceso__icono">📄</div>
            <div class="panel-acceso__contenido">
                <strong class="panel-acceso__titulo">Cotizaciones Foodtruck</strong>
                <span class="panel-acceso__desc">Genera cotizaciones profesionales para eventos y clientes</span>
            </div>
        </a>

        <a href="notas_cuenta.php" class="panel-acceso">
            <div class="panel-acceso__icono">🧾</div>
            <div class="panel-acceso__contenido">
                <strong class="panel-acceso__titulo">Notas de cuenta</strong>
                <span class="panel-acceso__desc">Clientes que piden diario y pagan a fin de semana</span>
            </div>
        </a>
