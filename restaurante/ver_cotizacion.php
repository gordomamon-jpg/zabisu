...
<head>
    ...
    <style>
        ...
        .prt-header { display:flex; align-items:flex-start; gap:16px; padding-bottom:24px; border-bottom:1px solid #222; margin-bottom:26px; }
        .prt-brand { display:flex; align-items:center; gap:16px; flex:none; }
